...
func _process(delta: float) -> void:
	for car_data in cars.duplicate():
		...
		# Judam link end_pos
		var move_vec = (end_pos - car_node.global_transform.origin).normalized() * speed * delta
